...
public class ScheduleVO {
	...
	private String s_date;	//fk (schedule)
	private String location_no; 	//fk
	...
	public ScheduleVO(int reservation_no, String reservation_nowdate, String member_id, String s_date,
			String location_no, String movie_name) {
		super();
		this.reservation_no = reservation_no;
		this.reservation_nowdate = reservation_nowdate;
		this.member_id = member_id;
